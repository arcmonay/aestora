...
export const packages: PackageDeal[] = [
  {
    ...
    summary: "The pressotherapy console and boots as a drainage-room invoice.",
    price: 4890,
    monthly: 136,
    includes: ["Linea Pressotherapy Tower", "Boot pair", "Protocol card"],
    productHandles: ["aestora-linea-pressotherapy-tower-1"],
  },
  {
    slug: "facial-studio",
    title: "Facial Studio Package",
    audience: "Esthetician suite or med-spa facial bay",
    summary: "Hydrodermabrasion as the facial menu, not a portrait of a client.",
    price: 4680,
    monthly: 130,
    includes: ["Atelier Hydrodermabrasion Tower", "Handpiece set", "Tip kit"],
    productHandles: ["aestora-atelier-hydrodermabrasion-tower-2"],
  },
  {
    slug: "body-contouring",
    title: "Body Contouring Package",
    audience: "Med spa body room",
    summary: "Floor cavitation cart plus the cryolipolysis platform.",
    price: 20100,
    monthly: 558,
    includes: ["Commercial Body Sculpt Combo", "Clinic Cryolipolysis Platform"],
    productHandles: ["aestora-commercial-body-sculpt-combo-3", "aestora-clinic-cryolipolysis-platform-5"],
  },
];
